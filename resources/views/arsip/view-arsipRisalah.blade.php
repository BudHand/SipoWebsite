                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="bg-white border rounded-2 px-3 py-2 w-100 d-flex align-items-center">
                            ...
                            <a href="{{ route('arsip.risalah') }}" class="text-decoration-none text-primary">Risalah
                                Rapat</a>
                            <span class="mx-2 text-muted">/</span>
                        ...
                        <div class="card border-0 shadow-sm rounded-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="info-row d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="info-value">{{ $risalah->tgl_dibuat->translatedFormat('d F Y') }}</div>
                                </div>

                                <div class="info-row d-flex flex-column flex-sm-row">
                                    <div class="info-label">Diterima</div>
                                    <div class="info-value">
                                        <pre class="info-value" style="white-space:pre-wrap;">{{ $tujuanUsernames }}</pre>
                                    </div>
                                </div>
                        ...
                        <div class="card border-0 shadow-sm rounded-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="info-row d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="info-value">
                                        {{ $risalah->user ? $risalah->user->fullname : 'N/A' }}
                                    </div>
                                </div>
                                ...
                                <div class="info-row d-flex flex-column flex-sm-row">
                                    ...
                                    <div class="info-value">
                                        <a href="{{ route('view-risalahPDF', $risalah->id_risalah) }}"
