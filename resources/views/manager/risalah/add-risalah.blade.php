    ...
    <div class="container-fluid px-4 py-0 mt-0">
        <div class="card shadow-sm border-0">
            <div class="card-body py-3">
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="bg-white border rounded-2 px-3 py-2 w-100 d-flex align-items-center">
                            ...
                            <a href="{{ route('risalah.manager') }}" class="text-decoration-none text-primary">Risalah</a>
                            <span class="mx-2 text-muted">/</span>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('risalah.store.manager') }}" method="POST" id="risalahForm"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-3 align-items-end mt-1">
                                        <div class="col-md-12">
                                            <label class="form-label">
                                                <i class="fas fa-tag text-primary me-1"></i> Judul <span
                                                    class="text-danger">*</span>
                                            </label>
                                    ...
                                    <div class="row g-3 align-items-end mt-1">
                                        ...
                                        <div class="col-md-6">
                                            <label class="form-label mb-1">
                                                <i class="fas fa-map-marker-alt text-primary me-1"></i> Tempat Acara <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <input type="text" name="tempat" id="tempat" class="form-control"
                                                required placeholder="Harap pilih judul terlebih dahulu">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3 align-center mt-1">
                                        ...
                                        {{-- <div class="col-md-6">
                                            ...
                                            <!-- BUNGKUS INPUT FILE + NOTES AGAR HEIGHT SAMA -->
                                    ...
                                    <div class="card-footer d-flex justify-content-end gap-2 mt-3">
                                        <a href="{{ route('risalah.manager') }}" class="btn rounded-3"
                                            style="background:#fff;color:#0d6efd;border:1px solid #0d6efd;">Batal</a></a>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (judulSelect) {
                $('#judul').on('change', function() {
                    ...
                    // populateSelect("#notulis_acara", tujuanNames);
                });
            }
            ...
            document.addEventListener('click', function(e) {
                if (e.target && (e.target.classList.contains('hapus-risalah-btn') || e.target.closest(
                        '.hapus-risalah-btn'))) {
                    e.preventDefault();
                    const button = e.target.closest('.hapus-risalah-btn');
                ...
                tambahRisalahBtn.addEventListener('click', function(e) {
                    ...
                    newRow.innerHTML = `
                        ...
                        <div class="col-md-2">
                            ...
                            <textarea class="form-control" name="topik[]" placeholder="Topik" rows="2" required></textarea>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Uraian Permasalahan</label>
                            <textarea class="form-control" name="uraian_permasalahan[]" placeholder="Uraian Permasalahan" rows="2" required></textarea>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Pembahasan / Tindak Lanjut</label>
                            <textarea class="form-control" name="pembahasan_tindak_lanjut[]" placeholder="Pembahasan / Tindak Lanjut" rows="2" required></textarea>
                        </div>
                        <div class="col-md-1">
            ...
            // Form submit + double click prevention
            ...
            if (risalahForm && submitBtn) {
                ...
                risalahForm.addEventListener('submit', function(e) {
                    ...
                    // Validasi lolos → disable button + spinner
            ...
            `;
                ...
                // Reset button kalau ada error reload dari server
                    ...
                    if (errorElements.length > 0) {
                        setTimeout(function() {
                            if (submitBtn.disabled) {
                                ...
                                console.log('✓ Submit button direset karena ada error server');
                            }
                        }, 500);
                    }
                });
            ...
            setTimeout(function() {
                ...
                console.log('Tombol tambah:', tambahRisalahBtn ? '✓' : '❌');
                console.log('Container:', document.getElementById('risalahContainer') ? '✓' : '❌');
                console.log('Form:', risalahForm ? '✓' : '❌');
