    ...
    <div class="container-fluid px-4 py-0 mt-0">
        <div class="card shadow-sm border-0">
            <div class="card-body py-3">
                ...
                {{-- Row Filter --}}
                <form class="row g-2 align-items-center" method="GET" action="{{ route('undangan.terkirim') }}">
                    {{-- <div class="col-auto">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                @elseif ($undangan->status == 'pending' || $undangan->status == 'correction')
                                                    @if (Auth::user()->id == $undangan->undangan->pembuat)
                                                        <button type="button"
                                                            class="btn btn-sm rounded-circle text-white border-0 bg-secondary"
                                                            style="width:30px; height:30px; display:flex; align-items:center; justify-content:center;"
                                                            onclick="window.location.href='{{ route('undangan.edit', ['id' => $undangan->undangan->id_undangan]) }}'">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                @if (session('success') === 'Status undangan berhasil diperbarui.')
                    showAlert('Status undangan berhasil diperbarui.', 'success');
                @endif

                @if (session('success') === 'Undangan rapat berhasil dibuat.')
                    showAlert('Undangan rapat berhasil dibuat.', 'success');
                @endif
