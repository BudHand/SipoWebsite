        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body py-3">
                ...
                <div class="row g-3">
                    ...
                    {{-- UNDANGAN Keluar --}}
                    <div class="col-12 col-sm-6 col-lg-3">
                        <a href="{{ route('undangan.terkirim') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm h-100 card-hover"
                    ...
                    {{-- UNDANGAN Masuk --}}
                    <div class="col-12 col-sm-6 col-lg-3">
                        <a href="{{ route('undangan.diterima') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm h-100 card-hover"
                    ...
                    <div class="col-12 col-lg-12">
                        <a href="{{ route('risalah.manager') }}" class="text-decoration-none">
                            <div class="card border-0 shadow-sm h-100 card-hover"
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <p class="mb-0 text-muted small lh-sm">
                                                            ...
                                                            @if ($notif->judul_document)
                                                                • <span
                                                                    class="text-{{ $bgColor }} fw-semibold">{{ $notif->judul_document }}</span>
                                                            @endif
                                                        </p>
                                                    </div>
                                                </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Chart Distribusi Dokumen (Bar Chart)
            const ctxDistribusi = document.getElementById('chartDistribusi');
            if (ctxDistribusi) {
                new Chart(ctxDistribusi, {
                    type: 'bar',
                    data: {
                        labels: ['Memo Keluar', 'Memo Masuk', 'Undangan Keluar', 'Undangan Masuk',
                            'Risalah Rapat'
                        ],
                        datasets: [{
                            label: 'Jumlah Dokumen',
                            data: [memoMasuk, memoKeluar, undanganMasuk, undanganKeluar, risalah],
                            backgroundColor: [
