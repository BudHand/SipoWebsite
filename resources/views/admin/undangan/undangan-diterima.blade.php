    ...
    <div class="container-fluid px-4 py-0 mt-0">
        <div class="card shadow-sm border-0">
            <div class="card-body py-3">
                ...
                <h3 class="fw-bold mb-3">Undangan Masuk</h3>
                ...
                <div class="row mb-3">
                    <div class="col-12">
                        <div class="bg-white border rounded-2 px-3 py-2 w-100 d-flex align-items-center">
                            ...
                            <span class="text-muted ms-1">/ Undangan Masuk</span>
                        </div>
                    </div>
                </div>

                {{-- Row Filter --}}
                <form class="row g-2 align-items-center" method="GET" action="{{ route('admin.undangan.diterima') }}">
                    <div class="col-auto">
                    ...
                    <table class="table table-bordered custom-table-bagian">
                        ...
                        <tbody>
                            ...
                            {{ $undangan->status == 'reject' ? 'text-danger' : ($undangan->status == 'correction' ? 'text-warning' : ($undangan->status == 'approve' ? 'text-success' : '')) }}"
                                        ...
                                        <td class="text-center">{{ $undangan->kode_bagian ?? 'No Divisi Assigned' }}</td>
