        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateNomor() {
                    const items = document.querySelectorAll('.risalah-item');
                    items.forEach((item, index) => {
                        ...
                        const subRows = item.querySelectorAll('.sub-risalah-row');
                        subRows.forEach(subRow => {
                            subRow.querySelectorAll('[data-sub-name]').forEach(el => {
                                const field = el.dataset.subName;
                                el.name = `${field}[${index}][]`;
                            });
                        });
                    });

                    console.log(`Nomor diupdate untuk ${items.length} item risalah`);
                }
                ...
                document.addEventListener('click', function(e) {
                    ...
                    if (hapusRisalahBtn) {
                        ...
                        if (item) {
                            item.remove();
                            updateNomor();
                            console.log('Item risalah berhasil dihapus');
                        }
                        return;
                    }
                    ...
                    if (hapusSubBtn) {
                        ...
                        if (subRow) {
                            subRow.remove();
                            console.log('Sub risalah berhasil dihapus');
                        }
                        return;
                    }
                ...
                if (tambahRisalahBtn) {
                    ...
                    tambahRisalahBtn.addEventListener('click', function(e) {
                        ...
                        const itemIndex = document.querySelectorAll('.risalah-item').length;

                        const itemWrapper = document.createElement('div');
                        itemWrapper.className = 'risalah-item card mb-3';
                        ...
                        itemWrapper.innerHTML = `
                            <div class="card-body">
                                ...
                                <div class="sub-risalah-container mt-2"></div>
                            </div>
                        `;
                ...
                subRow.className = 'sub-risalah-row row g-2 mt-2 ms-4 me-0 border-start border-3 ps-3';

                subRow.innerHTML = `
                    <div class="col-md-2" style="display: flex; flex-direction: column;">
                        <label class="form-label text-muted">Sub Topik</label>
                    ...
                    <div class="col-md-3" style="display: flex; flex-direction: column;">
                        <label class="form-label text-muted">Sub Pembahasan</label>
                        <textarea class="form-control"
                    ...
                    <div class="col-md-2" style="display: flex; flex-direction: column;">
                        <label class="form-label text-muted">Sub Tindak Lanjut</label>
                        <textarea class="form-control"
                    ...
                    <div class="col-md-2" style="display: flex; flex-direction: column;">
                        <label class="form-label text-muted">Sub Target</label>
                        <textarea class="form-control"
                    ...
                    <div class="col-md-2" style="display: flex; flex-direction: column;">
                        <label class="form-label text-muted">Sub PIC</label>
                        <textarea class="form-control"
                    ...
                    <div class="col-md-1 d-flex align-items-center justify-content-center">
                        <button type="button" class="btn btn-outline-danger btn-sm hapus-sub-risalah-btn">
                            <i class="fas fa-trash"></i>
                        </button>
                    </div>
                `;
