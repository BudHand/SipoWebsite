                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="waktu_selesai" id="waktu_selesai" class="form-control"
                                            placeholder="Selesai" value="{{ $risalah->waktu_selesai }}" required>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger" style="font-size: x-small">
                                                Pilih user atau struktur, semua user di bawah struktur akan otomatis
                                                terpilih
                                            </small>
                                    ...
                                    @foreach ($risalah->risalahDetails as $detailIndex => $detail)
                                        <div class="risalah-item card mb-4 border-0 shadow-sm"
                                            ...
                                            <div class="card-header d-flex align-items-center justify-content-between py-2 px-3"
                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <span class="text-white fw-semibold"
                                                        style="font-size:.9rem; letter-spacing:.02em;">Isi Risalah</span>
                                                </div>
                                            ...
                                            <div class="card-body p-4">
                                                <input type="hidden" class="no-auto" name="nomor[]"
                                                    value="{{ $detail->nomor }}">
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-md-4">
                                                        <label class="form-label fw-semibold mb-1"
                                                            ...
                                                            <i class="fas fa-project-diagram text-primary me-1"></i> Proyek
                                                            / Event
                                                        </label>
                                                        {{-- <input type="text" class="form-control form-control-sm"
                                                            name="project_event[]" value="{{ $detail->project_event }}"
                                                            placeholder="Nama proyek atau event..."
                                                            style="border-radius:6px; font-size:.87rem;"> --}}
                                                        <textarea class="form-control form-control-sm" name="project_event[]" placeholder="Nama proyek atau event..."
                                                            rows="2" required style="resize:vertical; border-radius:6px; font-size:.87rem;">{{ $detail->project_event }}</textarea>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <label class="form-label fw-semibold mb-1"
                                                            style="font-size:.82rem; color:#374151;">
                                                            <i class="fas fa-tag text-primary me-1"></i> Topik <span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <textarea class="form-control form-control-sm"
                                                            name="topik[]" placeholder="Topik pembahasan..." required
                                                            style="resize:vertical; border-radius:6px; font-size:.87rem;">{{ $detail->topik }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label fw-semibold mb-1"
                                                            style="font-size:.82rem; color:#374151;">
                                                            <i class="fas fa-comments text-primary me-1"></i> Uraian
                                                            Permasalahan <span class="text-danger">*</span>
                                                        </label>
                                                        <textarea class="form-control form-control-sm" name="uraian_permasalahan[]" rows="3" required
                                                            style="resize:vertical; border-radius:6px; font-size:.87rem;">{{ $detail->uraian_permasalahan }}</textarea>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label fw-semibold mb-1"
                                                            style="font-size:.82rem; color:#374151;">
                                                            <i class="fas fa-tasks text-primary me-1"></i> Pembahasan /
                                                            Tindak Lanjut <span class="text-danger">*</span>
                                                        </label>
                                                        <textarea class="form-control form-control-sm" name="pembahasan_tindak_lanjut[]" rows="3" required
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        <label class="form-label fw-semibold mb-1"
                                                            style="font-size:.82rem; color:#374151;">
                                                            <i class="fas fa-calendar-check text-primary me-1"></i> Target
                                                            <span class="text-danger">*</span>
                                                        </label>
                                                        <textarea class="form-control form-control-sm" name="target[]" rows="2" required
                                                            style="resize:vertical; border-radius:6px; font-size:.87rem;">{{ $detail->target }}</textarea>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="form-label fw-semibold mb-1"
                                                            style="font-size:.82rem; color:#374151;">
                                                            <i class="fas fa-user-check text-primary me-1"></i> PIC <span
                                                                class="text-danger">*</span>
                                                        </label>
                                                        <textarea class="form-control form-control-sm" name="pic[]" placeholder="Person in charge..." rows="2"
                                                            required style="resize:vertical; border-radius:6px; font-size:.87rem;">{{ $detail->pic }}</textarea>
                                                    </div>
                                                    {{-- <div class="col-md-6">
                                                ...
                                                {{-- Sub Risalah --}}
                                                <div class="sub-risalah-wrapper mt-4 pt-3"
                                                    style="border-top:1.5px dashed #cbd5e1;">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="fw-semibold text-muted" style="font-size:.82rem;">
                                                            <i class="fas fa-sitemap text-primary me-1"></i> Sub Isi
                                                            Risalah
                                                        </span>
                                                    ...
                                                    <div class="sub-risalah-container">
                                                            ...
                                                            @foreach ($detail->subDetails as $subDetail)
                                                                <div class="sub-risalah-row position-relative mt-3">
                                                                    <div class="card border-0 shadow-sm"
                                                                        style="background:#f0f4ff; border-left:3px solid #4f6ef7 !important; border-radius:8px;">
                                                                        <div class="card-body py-3 px-3">
                                                                            <div
                                                                                class="d-flex align-items-center justify-content-between mb-3">
                                                                                <span class="sub-badge badge fw-semibold"
                                                                                    style="background:#4f6ef7; font-size:.72rem; letter-spacing:.03em;">
                                                                                    <i class="fas fa-code-branch me-1"></i>
                                                                                    Sub {{ $loop->iteration }}
                                                                                </span>
                                                                                <button type="button"
                                                                                    class="btn btn-sm hapus-sub-risalah-btn"
                                                                            ...
                                                                            <div class="row g-3">
                                                                                <div class="col-md-4">
                                                                                    <label
                                                                                        ...
                                                                                        style="font-size:.8rem; color:#555;">Sub
                                                                                        Topik</label>
                                                                                    <textarea class="form-control form-control-sm" data-sub-name="sub_topik" name="sub_topik[{{ $detailIndex }}][]"
                                                                                        rows="2" style="resize:vertical; border-radius:6px; font-size:.85rem;">{{ $subDetail->topik }}</textarea>
                                                                                </div>
                                                                                <div class="col-md-4">
                                                                                    <label
                                                                                        class="form-label fw-semibold mb-1"
                                                                                        style="font-size:.8rem; color:#555;">Sub
                                                                                        Pembahasan</label>
                                                                                    <textarea class="form-control form-control-sm" data-sub-name="sub_pembahasan"
                                                                                        name="sub_pembahasan[{{ $detailIndex }}][]" rows="2"
                                                                                ...
                                                                                <div class="col-md-4">
                                                                                    <label
                                                                                        ...
                                                                                        style="font-size:.8rem; color:#555;">Sub
                                                                                        Tindak Lanjut</label>
                                                                                    <textarea class="form-control form-control-sm" data-sub-name="sub_tindak_lanjut"
                                                                                        name="sub_tindak_lanjut[{{ $detailIndex }}][]" rows="2"
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <label
                                                                                        ...
                                                                                        style="font-size:.8rem; color:#555;">Sub
                                                                                        Target</label>
                                                                                    <textarea class="form-control form-control-sm" data-sub-name="sub_target" name="sub_target[{{ $detailIndex }}][]"
                                                                                        rows="2" style="resize:vertical; border-radius:6px; font-size:.85rem;">{{ $subDetail->target }}</textarea>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                    <label
                                                                                        class="form-label fw-semibold mb-1"
                                                                                        style="font-size:.8rem; color:#555;">Sub
                                                                                        PIC</label>
                                                                                    <textarea class="form-control form-control-sm" data-sub-name="sub_pic" name="sub_pic[{{ $detailIndex }}][]"
                                                                                        rows="2" style="resize:vertical; border-radius:6px; font-size:.85rem;">{{ $subDetail->pic }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        @else
                                                            <div class="sub-empty-state text-center py-3 rounded-2"
                                                                ...
                                                                <i class="fas fa-layer-group me-1"></i> Belum ada sub isi
                                                                risalah.
                                                            </div>
                                                        @endif
                                                    </div>
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        ...
                        <textarea class="form-control form-control-sm mt-2" name="project_event[]" placeholder="Nama proyek atau event..."
                            rows="2" style="resize:vertical; border-radius:6px; font-size:.87rem;"></textarea>
                    </div>
                    <div class="col-md-8">
                        <label class="form-label fw-semibold mb-1" style="font-size:.82rem; color:#374151;">
            ...
            if (lampiranInputContainer && lampiranInput && lampiranList) {
                ...
                function handleLampiranChange(e) {
                    ...
                    infoWrapper.innerHTML =
                        `<span>${file.name}</span><div class="progress mt-1" style="height:4px;"><div class="progress-bar" style="width:100%"></div></div>`;
